...
def get_all_mat_xdf_file_names(data_path, subject_id, session_id):
    ...
    return all_mat_files, all_xdf_files
...
def get_specific_run(data_path, subject_id, session_id, run_id):
    ...
    """
    all_mat_files, all_xdf_files = get_all_mat_xdf_file_names(data_path, subject_id, session_id)
    ...
    return current_mat , current_xdf
